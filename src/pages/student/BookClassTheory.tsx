...
import StudentTheoryClasses from '@/pages/student/StudentTheoryClasses';
import { ROUTES } from '@/constants/routes';

/** Paso 2 del flujo Agendar clase — inscripción en sesiones teóricas. */
export default function BookClassTheory() {
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <ScheduleTypeBadge type="THEORY" />
      </div>

      <StudentTheoryClasses />
    </div>
  );
}
